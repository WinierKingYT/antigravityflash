...
class ReleaseConsistencyTestSuite(unittest.TestCase):
    def test_version_alignment(self):
        """Verify version is 1.2.5 across pyproject.toml, package __init__, installer, and README."""
        # pyproject.toml
        ...
        self.assertEqual(pyproject_ver, "1.2.5")
        ...
        self.assertEqual(match_init.group(1), "1.2.5")
        ...
        self.assertIn("V1.2.5", readme_text)
        self.assertIn("badge/version-1.2.5-blue.svg", readme_text)
